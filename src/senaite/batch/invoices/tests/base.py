# -*- coding: utf-8 -*-
#
# This file is part of SENAITE.BATCH.INVOICES.
#
# SENAITE.BATCH.INVOICES is free software: you can redistribute it and/or modify it
...
class SimpleTestLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        zope.installProduct(app, "senaite.batch.invoices")
...
SIMPLE_TESTING = FunctionalTesting(
    bases=(SIMPLE_FIXTURE,), name="senaite.batch.invoices:SimpleTesting"
)
